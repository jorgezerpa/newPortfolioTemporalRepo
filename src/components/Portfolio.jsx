...
export const Portfolio = () => {
  ...
  return (
    <>
      <h2 id="portfolio" className="text-gray-900 font-black text-center text-4xl md:text-4xl lg:text-5xl mb-10 md:mt-36 mt-20">Portfolio</h2>
      <div className='flex flex-col items-center justify-start gap-20'>
        <section ref={refS1} className={`${inViewS1 && 'animate-scaleX'} shadow-lg shadow-gray-400 rounded-xl opacity-0 origin-left w-[90%] flex flex-col md:flex-row min-h-[50vh]`}>
        ...
        <section ref={refS3} className={`${inViewS3 && 'animate-scaleX'} shadow-lg shadow-gray-400 rounded-xl opacity-0 origin-right w-[90%] flex flex-col-reverse md:flex-row min-h-[50vh]`}>
            <div className="mr-0 md:mr-2 rounded-xl border-[3px] flex-1 min-h-[300px] mt-5 sm:md-0 flex justify-center items-center py-14 md:py-0 bg-center bg-no-repeat bg-cover" style={{ backgroundImage: `url('/images/quickgames.png')` }}>
        
            </div>
              <div className="flex-1 flex justify-center items-start md:items-center">
                <div className="inline-block px-6">
                    <h2 className="mt-20 md:mt-0 text-gray-900 text-center md:text-left font-black text-2xl lg:text-3xl mb-5">Quick Projects</h2>
                    <p className="text-gray-500 text-center md:text-left font-semibold text-md max-w-[420px]">
                      "Sunday made" projects. This Section is a laboratory of Crazy design ideas, videogames, etc.                 
                    </p>
                    <Link to={'/quick-projects'} className="flex justify-center md:justify-start">
                      <div className="hover:scale-105 hover:shadow-md hover:shadow-gray-700 mt-5 inline-block bg-blue-900 text-white px-4 py-2 font-bold rounded-lg">see projects</div>
                    </Link>
                </div>
            </div>
        ...
        <section ref={refS2} className={`${inViewS2 && 'animate-scaleX'} opacity-0 shadow-lg shadow-gray-400 rounded-xl origin-left w-[90%] flex flex-col md:flex-row min-h-[50vh]`}>
            <div className="flex-1 flex justify-center items-start md:items-center">
                <div className="inline-block px-6">
