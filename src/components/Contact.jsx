        ...
        <section className="max-w-[800px] w-full flex flex-col md:flex-row min-h-[70vh]">
            <div className="flex-1 flex justify-center items-start md:items-center">
                <div className="inline-block">
                    <a href="https://www.linkedin.com/in/jorge-zerpa-code/" className="flex gap-1 mt-2 font-bold rounded-lg">
                        <span><img width="30px" src="/icons/linkedin.png" alt="" /></span>
                        jorge-zerpa-code
                    </a>
                    <a href="https://www.instagram.com/zerpa.code/" className="flex gap-1 mt-2 font-bold rounded-lg">
                        <span><img width="30px" src="/icons/instagram.png" alt="" /></span>
                        @zerpa.code
                    </a>
                    <a href="#" className="flex gap-1 mt-2 font-bold rounded-lg">
                        <span><img width="30px" src="/icons/email.png" alt="" /></span>
                        contact@zerpacode.com
                    </a>
                    <a href="https://api.whatsapp.com/send/?phone=584126436269&text&type=phone_number&app_absent=0" className="flex gap-1 mt-2 font-bold rounded-lg">
            ...
            <div className="flex-1 flex justify-center items-center py-14 md:py-0">
                <div className="w-[200px] h-[200px] rounded-[50%]">
                    ...
                    <div className="mt-2 flex justify-center">
                        <a href="#" className="rounded-xl py-2 px-5 font-bold bg-blue-700 mt-2 text-white">See my articles</a>
                    </div>
                </div>
            </div>
        </section>
